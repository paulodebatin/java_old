...
public class ContentTraceManager {
    ...
    protected String getRequestBody(
        ...
        try {
            ...
            //return Base64.getEncoder().encodeToString(wrappedRequest.getContentAsByteArray());
        } catch (Exception e) {
            logger.error(
    ...
    protected String getResponseBody(
        ...
        try {
            ...
            //return Base64.getEncoder().encodeToString(wrappedResponse.getContentAsByteArray());
        } catch (Exception e) {
            logger.error(
